{% set configs =[
    {
        "table": "walmart.silver_tch.orders_t",
        "columns": """o.order_id,
                        o.order_timestamp,
                        o.payment_method,
                        o.order_status,
    ...
    {
        "table": "walmart.silver_tch.customers_t",
    ...
    {
        "table": "walmart.silver_tch.orders_item",
    ...
    {
        "table": "walmart.silver_tch.products_t",
    ...
    {
        "table": "walmart.silver_tch.employees_t",
    ...
    {
        "table": "walmart.silver_tch.stores_t",
